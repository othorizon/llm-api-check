...
const paths: Record<string, string> = {
  ...
  gauge: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0-10 4.5-4.5M12 12h.01',
  cpu: 'M6 6h12v12H6zM9 2v2M15 2v2M9 20v2M15 20v2M2 9h2M2 15h2M20 9h2M20 15h2M10 10h4v4h-4z',
  wrench: 'M14.7 6.3a4 4 0 1 0 5 5L21 21H3l6.7-6.7a4 4 0 0 0 5-5Z',
  ...
  sparkles: 'm12 3 1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3ZM19 15l.9 2.1L22 18l-2.1.9L19 21l-.9-2.1L16 18l2.1-.9L19 15Z',
  ...
  github: 'M9 19c-5 1.5-5-2.5-7-3m14 6v-3.9a3.4 3.4 0 0 0-.9-2.6c3-.3 6.2-1.5 6.2-6.7a5.2 5.2 0 0 0-1.5-3.6 4.9 4.9 0 0 0-.1-3.6s-1.2-.3-3.9 1.5a13.4 13.4 0 0 0-7 0C6.1 1.2 4.9 1.5 4.9 1.5a4.9 4.9 0 0 0-.1 3.6A5.2 5.2 0 0 0 3.3 8.7c0 5.2 3.2 6.4 6.2 6.7a3.4 3.4 0 0 0-.9 2.6V22',
}
